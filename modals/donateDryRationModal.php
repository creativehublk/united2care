<!-- Modal -->
<div class="modal fade" id="donateDryRationModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" style="z-index: 99999">
                        ...
                        <form class="forms-sample" id="create_lead_form_info"
                            ...
                            <div class="tour_category_labels form-group flex-container">
                                ...
                                <div class="label_radio_design">
                                    <input type="radio" checked name="item[]" id="donateKitsChck_1" value="Dry Rations">
                                    <label for="donateKitsChck_1" class="text-capitalize" >Dry Rations</label>
                                </div>
