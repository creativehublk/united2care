    ...
    // Example
    function store_uploaded_image($target_dir, $img_name, $temp_name, $new_name, $new_img_width, $new_img_height = null) {
        ...
        $extension = $image->getExtension($img_name);
