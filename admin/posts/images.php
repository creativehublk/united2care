...
$images_array = array();
$select_all_images = mysqli_query($con,"SELECT * FROM `ad_post_images` WHERE `ad_post_id`='$post_id' ORDER BY `id` ASC ");
while($fetch_all_images = mysqli_fetch_array($select_all_images)){

    array_push($images_array,array(
        'image' => URL.'admin/uploads/posts/'.$fetch_all_images['name'],
    ...
    <body class="hold-transition skin-black-light layout-top-nav">
        ...
        <div class="wrapper">
            ...
            <div class="container">
                ...
                <div class="title">
                    <h3>Add images for your post</h3>
                </div>  <!-- ./ title -->
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <form class="forms-sample" id="create_product_form"
                                    data-action-after=2
                                    data-redirect-url="<?php echo URL ?>admin/posts/view_post.php?pro_id=<?php echo $post_id ?>"
                                    method="POST"
                                    action="<?php echo URL ?>admin/posts/ajax/update_images.php">
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <input type="hidden" name="update_post_id" value="<?php echo $post_id ?>" >
                                    <br>
