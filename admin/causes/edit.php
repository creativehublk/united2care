...
if($checkAccess == 1){ 
    ...
    $select = mysqli_query($localhost, "SELECT * FROM `causes` WHERE `id` = '$causes_id' ");
...
<html>
    <head>
        ...
        <title>Edit Causes | United2Care</title>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                ...
                                <form class="forms-sample" id="create_product_form"
                                    data-action-after=2
                                    data-redirect-url="<?php echo URL ?>admin/causes/causes.php"
                                    method="POST"
                                    ...
                                    <div class="col-sm-12 col-xs-12" >
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group  col-xs-12 col-sm-6">
                                                <label>Name</label>
                                                <input name="name" placeholder="Name" value="<?php echo $fetch['name'] ?>" class="form-control"  type="text" style="width:100%;" required>
                                            </div>
                                        ...
                                        <div class="col-sm-12 col-xs-12" >
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xs-12 col-md-12 form-group">
                                                    ...
                                                    <input type="hidden" name="edit_cause" value="<?php echo $causes_id ?>">
