...
<head>
	...
	<title> Dashboard Login | CreativeHub Shop</title>
<!--===============================================================================================-->	
		...
		<div class="container-login100">
			<div class="wrap-login100">
				<form class="login100-form validate-form"
					action="<?php echo URL ?>admin/accounts/ajax/login_handler.php"
					data-action-after=2
					data-redirect-url="<?php echo URL ?>admin/index.php"
					method="POST">
					...
					<div class="container-login100-form-btn">
						<button class="login100-form-btn submit_form_no_confirm" data-validate=0 type="button" name="login">
							Sign in
						</button>
					</div>
					...
					<div class="w-full text-center p-t-27 p-b-239">
						...
						<p>&copy; <?php echo date("Y");?> CreativeHub. All Rights Reserved.</p>
					</div>
