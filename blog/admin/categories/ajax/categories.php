...
while( $row=mysqli_fetch_array($query) ) {  // preparing an array
	...
	$edit_button = '<a href="'.URL.'blog/admin/categories/edit.php?id='.$id.'" class="btn btn-sm btn-outline-primary"> <i class="fa fa-edit"></i> </a>';
	$delete_button = '<button class="btn btn-outline-danger btn-sm" 
						onclick="deleteItem(this)" 
						data-id="'.$id.'" 
						data-after-success = 2
						data-refresh="refreshDatatable" 
						data-url="'.URL.'blog/admin/categories/ajax/controller/categoryHandler.php" 
						data-key="delete_cat">
